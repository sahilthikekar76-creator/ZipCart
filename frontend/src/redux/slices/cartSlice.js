...
//helper function to load the cart from local storage if it exists
...
//add an item to the cart for a user or gurest 
...
//merrge guest cart into logged in user cart
